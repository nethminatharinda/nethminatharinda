...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&multiline=true&width=600&height=100&lines=Hey+there!+I'm+Nethmina+%F0%9F%91%8B;Web+Dev+%7C+Bot+Dev+%7C+Entrepreneur+%F0%9F%9A%80" alt="Typing SVG" />
...
```yaml
name: Nethmina Tharinda
location: 🌏 Building from everywhere
role: Web Developer | Discord Bot Dev | Entrepreneur
current_projects:
  - 🚀 NETHX
  - 🌙 Moon Coder
learning:
  ...
  - Advanced JavaScript
specialties:
  - Discord Bots (slash cmds, buttons, APIs)
  - FiveM Server Systems
  - Modern Web UIs
fun_fact: "I build cool stuff at midnight 😎"
...
> Slash commands, interactive buttons, REST API integrations, and modular architecture.
...
### 🌐 Portfolio Website
> Modern, responsive UI built with clean HTML/CSS/JS — pixel-perfect on all devices.
...
### 🎮 FiveM Server Systems
> Custom Lua scripts, HUD interfaces, inventory systems, and server-side logic.
...
### 📱 Life Schedule App
> Flutter-based productivity app with clean design, task tracking & daily planning.
...
[![Website](https://img.shields.io/badge/Website-00D9FF?style=for-the-badge&logo=google-chrome&logoColor=black)](https://yourwebsite.com)
...
> *"Code. Create. Dominate."* 🚀 — **Nethmina Tharinda**
